        ...
        builder: (context,snapshot){
          if(snapshot.hasData){
            ...
            return Stepper(
              ...
              controlsBuilder:(context,deitals){
                return Row(
                  ...
                  children: [
                    Wrap(
                      children: [
                        if(currentStep == 2)
                          FilledButton(
                            onPressed: deitals.onStepContinue, 
                        ...
                        if (currentStep > 0)
                        TextButton(
                          onPressed: deitals.onStepCancel, 
...
class _Step1FormState extends State<Step1Form> {
  ...
  final phoneClt = TextEditingController();

  /// Hàm xác thực email bằng biểu thức chính quny
  ...
  bool isMobieValid(String value){
  ...
  Widget build(BuildContext context) {
    ...
    emailClt.text = widget.userInfo.email ?? '';
    phoneClt.text = widget.userInfo.phoneNumber ?? '' ;
    return Padding(
      ...
      child: Form(
        ...
        children: [
          ...
          TextFormField(
            controller: dateCtl,
            decoration: const InputDecoration(labelText: "Này sinh", hintText: "Nhập ngày sinh"),
            onTap: () async{
          ...
          TextFormField(
            ...
            validator: (value){
              if (value == null || value.isEmpty){
                ...
                return 'Định dạng email không hợp lê';
              }
              return null;
            },
...
class _Step2FormState extends State<Step2Form> {
  ...
  /// Hàm tải dữ liệu đơn vị hành chính
  Future<void> loadLocationData() async{
    try{
      ...
      wardList = 
        wardData.map((json)=>Ward.fromMap(json)).toList();
    }
    catch (e){
...
/// Load  stored  UserInfo data function 
